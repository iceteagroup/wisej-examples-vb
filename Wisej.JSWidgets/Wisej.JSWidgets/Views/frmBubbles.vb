...
Partial Public Class frmBubbles
    ...
    Private Sub btnConfirmUsername_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
    ...
    Private Sub frmBubbles_Load(ByVal sender As Object, ByVal e As EventArgs)
        bubble.SetBubbleValue(tagtxtbx, _maxTags)
    End Sub

    Private Sub btnSendMessage_Click(ByVal sender As Object, ByVal e As EventArgs)
        Try
    ...
    Private Sub cbx_SelectedValueChanged(ByVal sender As Object, ByVal e As EventArgs)
        bubble.SetBubbleValue(cbx, Convert.ToInt32(cbx.SelectedIndex) + 1)
    End Sub

    Private Sub numUpDwn_ValueChanged(ByVal sender As Object, ByVal e As EventArgs)
        bubble.SetBubbleValue(numUpDwn, Convert.ToInt32(numUpDwn.Value))
    End Sub

    Private Sub txtbx_TextChanged(ByVal sender As Object, ByVal e As EventArgs)
