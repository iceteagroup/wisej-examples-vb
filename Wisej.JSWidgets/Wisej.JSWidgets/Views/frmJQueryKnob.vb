...
Partial Public Class frmJQueryKnob
    ...
    Private Sub timerCurrentTime_Tick(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub frmJQueryKnob_Load(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub cmbLineStyle_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub cmbKnobStyle_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub cmbBorderStyle_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs)
