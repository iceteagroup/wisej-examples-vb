...
Partial Public Class Page1
    ...
    Private Sub widget1_WebRequest(ByVal sender As Object, ByVal e As WebRequestEventArgs) Handles widget1.WebRequest
    ...
    Private Async Sub widget1_WidgetEvent(ByVal sender As Object, ByVal e As WidgetEventArgs) Handles widget1.WidgetEvent
        Select Case e.Type
            Case "loaded"
    ...
    Private Async Sub comboBox1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles comboBox1.SelectedIndexChanged
