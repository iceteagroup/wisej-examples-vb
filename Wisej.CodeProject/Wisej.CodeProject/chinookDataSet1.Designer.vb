...
Partial Public Class chinookDataSet
    ...
    Partial Public Class employeesDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddemployeesRow(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal BirthDate As Date, ByVal Phone As String, ByVal Email As String) As employeesRow
            Dim rowemployeesRow As employeesRow = CType(Me.NewRow,employeesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, LastName, FirstName, Title, BirthDate, Phone, Email}
...
Namespace chinookDataSetTableAdapters
    ...
    Partial Public Class employeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [main].[sqlite_default_schema].[employees] WHERE (([EmployeeId] = @Or"& _ 
                "iginal_EmployeeId))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [main].[sqlite_default_schema].[employees] ([LastName], [FirstName], "& _ 
                "[Title], [BirthDate], [Phone], [Email]) VALUES (@LastName, @FirstName, @Title, @"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [main].[sqlite_default_schema].[employees] SET [LastName] = @LastName, [Fi"& _ 
                "rstName] = @FirstName, [Title] = @Title, [BirthDate] = @BirthDate, [Phone] = @Ph"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("chinookConnectionString").ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [EmployeeId], [LastName], [FirstName], [Title], [BirthDate], [Phone], [Ema"& _ 
                "il] FROM [employees]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As chinookDataSet.employeesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As chinookDataSet.employeesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As chinookDataSet.employeesDataTable = New chinookDataSet.employeesDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As chinookDataSet.employeesDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmployeeId As Long) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal Phone As String, ByVal Email As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal LastName As String, ByVal FirstName As String, ByVal Title As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal Phone As String, ByVal Email As String, ByVal Original_EmployeeId As Long) As Integer
            If (LastName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("LastName")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_EmployeeId,Long)
        ...
        Public Overridable Function UpdateAll(ByVal dataSet As chinookDataSet) As Integer
            ...
            Try 
                ...
                If (Not (Me._employeesTableAdapter) Is Nothing) Then
                    ...
                    Me._employeesTableAdapter.Connection = CType(workConnection,Global.System.Data.SQLite.SQLiteConnection)
                    Me._employeesTableAdapter.Transaction = CType(workTransaction,Global.System.Data.SQLite.SQLiteTransaction)
            ...
            Finally
                ...
                End If
                If (Not (Me._employeesTableAdapter) Is Nothing) Then
                    Me._employeesTableAdapter.Connection = CType(revertConnections(Me._employeesTableAdapter),Global.System.Data.SQLite.SQLiteConnection)
