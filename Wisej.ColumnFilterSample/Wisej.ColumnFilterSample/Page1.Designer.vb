...
#Region "Wisej Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Me.Column0 = New DataGridViewTextBoxColumn()
        Me.Column1 = New DataGridViewTextBoxColumn()
        Me.Column2 = New DataGridViewTextBoxColumn()
        Me.Column3 = New DataGridViewTextBoxColumn()
        Me.Column4 = New DataGridViewCheckBoxColumn()
        Me.SimpleColumnFilter = New Ext.ColumnFilter.ColumnFilter(Me.components)
        Me.WhereColumnFilter = New Ext.ColumnFilter.ColumnFilter(Me.components)
        ...
        'dataGridView1
        '
        Me.dataGridView1.Columns.AddRange(New DataGridViewColumn() {Me.Column0, Me.Column1, Me.Column2, Me.Column3, Me.Column4})
        ...
        Me.SimpleColumnFilter.FilterPanelType = GetType(Ext.ColumnFilter.SimpleColumnFilterPanel)
        Me.SimpleColumnFilter.ImageSource = "icon-search"
        '
        'WhereColumnFilter
        '
        Me.WhereColumnFilter.FilteredImageSource = "table-row-editing?color=#FF1700"
        Me.WhereColumnFilter.FilterPanelType = GetType(Ext.ColumnFilter.WhereColumnFilterPanel)
