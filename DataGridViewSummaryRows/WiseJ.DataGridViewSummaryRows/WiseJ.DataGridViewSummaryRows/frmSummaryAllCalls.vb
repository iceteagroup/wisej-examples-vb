...
''' 
''' </summary>
Public Class frmSummaryAllCalls
    ...
    Private Sub Window1_Load(ByVal sender As Object, ByVal args As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnSummary3_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSummary3.Click
        ...
        If dataGrid.Rows.Count > 0 Then
            Dim oColumn As DataGridViewColumn = dataGrid.Columns(6)

            'Equivalent in C# sample
            'DataGridViewColumn oColumn = this.dataGrid.Columns[6];
            grid.AddSummaryRows(SummaryType.Sum, DirectCast(Nothing, DataGridViewColumn), Nothing, Nothing, style)
            ...
            'TODO Fix Function with same call in C#
            grid.AddSummaryRows(SummaryType.Sum,
                                CType(Nothing, DataGridViewColumn),
                                Nothing,
                                oColumn,
                                style)
        End If
    ...
    Private Sub dataGrid_CellDoubleClick(ByVal sender As Object, ByVal e As DataGridViewCellEventArgs) Handles dataGrid.CellDoubleClick
        EditUser(CurrentUserId)
    End Sub
