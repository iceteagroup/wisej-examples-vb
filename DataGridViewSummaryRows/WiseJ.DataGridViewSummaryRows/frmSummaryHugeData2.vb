...
Partial Public Class frmSummaryHugeData2
    ...
    Private Sub frmSumaryGroup_Load(ByVal sender As Object, ByVal e As EventArgs)
    ...
    Private Sub btnSummary2_Click(sender As Object, e As EventArgs) Handles btnSummary2.Click
        AddSummary2()
    End Sub
