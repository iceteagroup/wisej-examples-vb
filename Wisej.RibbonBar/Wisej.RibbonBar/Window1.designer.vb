...
#End Region
    ...
    Friend WithEvents ribbonBarPage2 As Wisej.Web.Ext.RibbonBar.RibbonBarPage
    Friend WithEvents ribbonBarGroup1 As Wisej.Web.Ext.RibbonBar.RibbonBarGroup
    Friend WithEvents ribbonBarGroup2 As Wisej.Web.Ext.RibbonBar.RibbonBarGroup
    Friend WithEvents ribbonBarGroup3 As Wisej.Web.Ext.RibbonBar.RibbonBarGroup
    Friend WithEvents ribbonBarGroup4 As Wisej.Web.Ext.RibbonBar.RibbonBarGroup
    ...
    Friend WithEvents ribbonBarItemButton3 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemSeparator1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemSeparator
    Friend WithEvents ribbonBarItemButton4 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton5 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton6 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents menuItem1 As Web.MenuItem
    Friend WithEvents menuItem2 As Web.MenuItem
    Friend WithEvents ribbonBarItemSplitButton1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemSplitButton
    Friend WithEvents menuItem3 As Web.MenuItem
    Friend WithEvents menuItem4 As Web.MenuItem
    Friend WithEvents ribbonBarItemButton7 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemCheckBox1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemCheckBox
    Friend WithEvents ribbonBarItemCheckBox2 As Wisej.Web.Ext.RibbonBar.RibbonBarItemCheckBox
    Friend WithEvents ribbonBarItemTextBox1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemTextBox
    Friend WithEvents ribbonBarItemTextBox2 As Wisej.Web.Ext.RibbonBar.RibbonBarItemTextBox
    Friend WithEvents ribbonBarItemComboBox1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemComboBox
    Friend WithEvents ribbonBarItemControl1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemControl
    Friend WithEvents themePicker1 As ThemePicker
    Friend WithEvents ribbonBarPage3 As Wisej.Web.Ext.RibbonBar.RibbonBarPage
    Friend WithEvents ribbonBarGroup5 As Wisej.Web.Ext.RibbonBar.RibbonBarGroup
    Friend WithEvents ribbonBarItemButtonGroup1 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButtonGroup
    Friend WithEvents ribbonBarItemButton12 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton13 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton14 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton15 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton16 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButtonGroup2 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButtonGroup
    Friend WithEvents ribbonBarItemButton17 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton18 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton19 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton20 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
    Friend WithEvents ribbonBarItemButton21 As Wisej.Web.Ext.RibbonBar.RibbonBarItemButton
End Class
