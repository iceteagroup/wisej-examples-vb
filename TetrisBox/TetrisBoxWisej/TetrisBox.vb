...
Imports KeyEventArgs = Wisej.Web.KeyEventArgs
...
#Region "Private Variables"
    ...
    Private _timer As Wisej.Web.Timer = Nothing     'Timer used to drop the falling block 1 row automatically.
...
#Region "Constructor"
    Public Sub New()
        ...
        AddHandler MyBase.Paint, AddressOf Me_OnPaint

        AddHandler MyBase.KeyDown, AddressOf Me_hook_KeyDown
...
#Region "Public Auto-Implemented Properties"
    ...
    Public Property LeftKey As Wisej.Web.Keys = Wisej.Web.Keys.Left     'Allows to customize the Left key for the game (defaults to the left direction key)
    Public Property RightKey As Wisej.Web.Keys = Wisej.Web.Keys.Right   'Allows to customize the Right key for the game (defaults to the right direction key)
    Public Property RotateKey As Wisej.Web.Keys = Wisej.Web.Keys.Up     'Allows to customize the Rotate key for the game (defaults to the up direction key)
    Public Property DropKey As Wisej.Web.Keys = Wisej.Web.Keys.Down     'Allows to customize the Drop key for the game (defaults to the down direction key)
    Public Property Block1Color As Color = Color.Red        'Allows to customize the color of the type 1 blocks
    Public Property Block2Color As Color = Color.Blue       'Allows to customize the color of the type 2 blocks
    Public Property Block3Color As Color = Color.Green      'Allows to customize the color of the type 3 blocks
    Public Property Block4Color As Color = Color.Aqua       'Allows to customize the color of the type 4 blocks
...
#Region "OnPaint"
    ...
    Private Sub Me_OnPaint(ByVal sender As Object, e As Wisej.Web.PaintEventArgs)
...
#Region "Private Methods And Functions"
    ...
    Private Sub Me_hook_KeyDown(sender As Object, Key As KeyEventArgs)
        If (Not Me.IsPaused) Then

            Select Case Key.KeyData
                Case Wisej.Web.Keys.Left ' left 1
                    If _board.MoveLeft() Then Call RedrawAndCheckBlock()
                Case Wisej.Web.Keys.Right ' 2
                    If _board.MoveRight() Then Call RedrawAndCheckBlock()
                Case Wisej.Web.Keys.Up     '3
                    If _board.Rotate() Then Call RedrawAndCheckBlock()

                Case Wisej.Web.Keys.Down '4
